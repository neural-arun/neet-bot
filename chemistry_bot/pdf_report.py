...
def generate_report(chapter, correct, total, questions, answers, ai_analysis, wrong=0, unanswered=0):
    ...
    q_styles = (q_style, opt_styles, badg_style, score_style, ParagraphStyle('Sol', fontSize=9, leading=13, textColor=TEXT_DARK, fontName='Helvetica', spaceBefore=2, spaceAfter=2))
    elements = []
